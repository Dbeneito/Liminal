...
const Admin = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`${API_URL}/api/projects`, { headers }).then(res => setProjects(res.data)).catch(() => {})
    axios.get(`${API_URL}/api/referents`, { headers }).then(res => setReferents(res.data)).catch(() => {})
    axios.get(`${API_URL}/api/categories`, { headers }).then(res => setCategories(res.data)).catch(() => {})
  }, [ready, token])
